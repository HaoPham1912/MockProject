...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="#" onclick="callContent('manageUser'); return false;">
                    <i class="fa fa-id-card" style="color: rgb(245, 164, 13)"></i>
                    <span class="text-nav">Manage User</span></a>
            </li>
            <!-- Nav Item-Manage System -->
            <li class="nav-item active">
                <a class="nav-link" href="#" onclick="callContent('manageUser'); return false;">
                    <i class="fa fa-cogs" style="color: rgb(245, 164, 13)"></i>
                    <span class="text-nav">Manage System</span></a>
            </li>
            <!-- Divider -->
            ...
            <div id="content">
                ...
                <div class="container-fluid generalClass" id="manageUser">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><strong>Quản lý user</strong></h1>
                ...
                class="fas fa-download fa-sm text-white-50"></i> Generate Report</a> -->
                    ...
                    <div>
                        <div class="text-right">
                            <p data-placement="top" data-toggle="tooltip" title="Create new user"><button
                                    class="btn btn-primary" data-title="Create new user" data-toggle="modal"
                                    data-target="#addUser"><span class="fas fa-plus-circle">&nbsp; Create new
                                        user</span></button></p>
                        </div>
                        <div>
                            <!-- Thêm user-Start -->
                                    ...
                                    <div class="modal-content">
                                        <form class="" action="" method="">
                                            ...
                                            <div class="modal-header">
                                                <h4 class="modal-title" style="margin-left: auto"><strong>Create new
                                                        user</strong>
                                                </h4>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control " id="phoneUser" type="number"
                                                        placeholder="01293948384" pattern="[0-9]{1,}" title="" required>
                                                </div>
                                                <!-- Phone user -->
                                                <!-- Email User -->
                                                <div class="form-group">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="submit" id="submitAddPokestop"
                                                        ...
                                                        style="width: 100%;"><span
                                                            class="	fas fa-check-circle"></span>Thêm</button>
                                                </div>
                                            </div>
                    ...
                    <!-- Phần nội dung trong bảng user-Start -->
                    <div class="col-md-12">
                            ...
                            <table id="mytable" class="table table-bordred table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Lê Văn Duy</td>
                                        <td>113</td>
                                        <td>duyvl@gmail.com</td>
                                        <td>Bien Hoa Hotel</td>
                                        <td>
                                            <p data-placement="top" data-toggle="tooltip" title="Edit"><button
                                                    class="btn btn-primary" data-title="Edit" data-toggle="modal"
                                                    onclick="editUser()"><span class="	fa fa-edit"></span></button>
                                            </p>
                                        </td>
                                        <td>
                                            <p data-placement="top" data-toggle="tooltip" title="Delete"><button
                                                    class="btn btn-danger" data-title="Delete" data-toggle="modal"
                                                    onclick="deleteUser()"><span class="fa fa-trash"></span></button>
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="alert alert-danger"><span
                                            class="glyphicon glyphicon-warning-sign"></span> Do you want to delete this
                                        user?
                                    </div>
                                </div>
                                <div class="modal-footer ">
                                    <button id="yesdeleteUser" type="button" class="btn btn-success"><span
                                            class="	fas fa-check-circle"></span> Yes</button>
                                    <button type="button" class="btn btn-default" data-dismiss="modal"><span
                                            class="fas fa-remove"></span> No</button>
                                </div>
                            </div>
                            <!-- /.modal-content -->
                        </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form class="" action="" method="">
                                    <!-- Modal Header -->
                                    <div class="modal-header">
                                        <h4 class="modal-title" style="margin-left: auto"><strong>Update User
                                                Information</strong>
                                        </h4>
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    </div>
                                    <div class="modal-body">
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" id="submitEditUser" class="btn btn-warning btn-lg"
                                                style="width: 100%;"><span
                                                    class="	fas fa-check-circle"></span>Update</button>
    ...
    <script src="Admin/https://cdn.jsdelivr.net/gh/gitbrent/bootstrap4-toggle@3.4.0/js/bootstrap4-toggle.min.js"></script>
