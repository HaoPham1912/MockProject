        ...
        <div id="header-top" class="d-none d-xl-block">
            <div class="container">
                <div class="row">
                    ...
                    <!--== Single HeaderTop Start ==-->
                    <div class="col-lg-3 text-center">
                        <i class="fa fa-clock-o"></i> <script>document.write(new Date().getDate()+ "/" + (new Date().getMonth()+1) 
                        		+ "/" + new Date().getFullYear() + " @ " 
                        		+ new Date().getHours() + ":" 
                        		+ new Date().getMinutes() + ":" + new Date().getSeconds());</script>
                    </div>
                    <!--== Single HeaderTop End ==-->
                    ...
                    <div class="booka-car-content" style="padding-left: 200px">
                         <form action="index3.html">
                            <div class="header-text">
                                <p>BusBooking.com- Book Your Trip Now</p><br/></div>
